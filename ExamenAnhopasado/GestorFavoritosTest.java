...
public class GestorFavoritosTest {
    ...
    public void testMarcarFavorito() {
        ...
        List<Inmueble> favoritosPersona1 = gestorFavoritos.getFavoritos(persona1);
        List<Inmueble> favoritosPersona2 = gestorFavoritos.getFavoritos(persona2);
    ...
    public void testGetFavoritosEnComun() {
        ...
        List<Inmueble> favoritosEnComun = gestorFavoritos.getFavoritosEnComun(persona1, persona2);
